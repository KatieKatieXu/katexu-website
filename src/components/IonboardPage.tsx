    ...
    content: (
      <div className="mt-[34px]">
        ...
        <a
          ...
          onClick={() => posthog.capture("kickstarter_link_clicked", { project_name: "Ionboard" })}
        >
...
export default function IonboardPage() {
  ...
  const handleSectionChange = (section: SectionKey) => {
    ...
    posthog.capture("project_section_navigated", { project_name: "Ionboard", section });
  };
          ...
          <div className="flex-1 flex flex-col justify-center pl-[32px]">
            <nav className="space-y-[32px]">
              ...
              <NavItem
                ...
                onClick={() => handleSectionChange("reflections")}
              />
            </nav>
          </div>
        </div>
              ...
              <div className="mb-[32px]">
                ...
                {activeSection === "vision" && (
                  <Link
                    ...
                    onClick={() => posthog.capture("project_deck_clicked", { project_name: "Ionboard" })}
                  >
      ...
      <div className="md:hidden absolute inset-0 flex flex-col overflow-x-hidden">
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto pb-40">
          <div className="bg-white/85 backdrop-blur-lg mx-2 my-4 rounded-xl p-4 min-h-[calc(100vh-180px)]">
            ...
            <div className={`w-[60px] h-[3px] bg-[#00bc7d] mt-4 ${activeSection === "vision" ? "" : "mb-8"}`} />
            {activeSection === "vision" && (
              <Link
                href="/projects/ionboard/deck"
