  ...
  return (
    <div className="min-h-screen w-full bg-[#fdfbf7] flex flex-col">
      ...
      <div className="sticky top-0 z-20 flex items-center justify-between p-4 md:p-6 bg-white/80 backdrop-blur-md border-b border-gray-200/50">
        ...
        <a
          href="/KateXu_Resume_7_27.pdf"
          download="KateXu_Resume.pdf"
          className="px-4 py-2 bg-[#111111] text-white text-sm font-semibold rounded-full hover:bg-[#00a86b] transition-colors flex items-center gap-2"
      ...
      <div className="md:hidden flex-1 flex flex-col items-center px-3 py-4">
        ...
        >
          ...
          <iframe
            src="/KateXu_Resume_7_27.pdf#view=FitH"
            className="w-full h-full border-0"
            title="Kate Xu Resume"
        ...
        <a
          ...
          className="mt-4 mb-6 px-5 py-2.5 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-600 hover:text-[#111111] hover:border-[#111111] transition-colors shadow-sm flex items-center gap-2"
        >
